#!/bin/bash
#SBATCH --job-name="centerpoint_e3_1_ro47020"
...
#SBATCH --output=outputs/slurm_centerpoint_e3_1_ro47020_%j.out
#SBATCH --error=outputs/slurm_centerpoint_e3_1_ro47020_%j.err
...
default_args=(model=centerpoint_radar_pfn2_gate_e3_1 exp_id=radar_pfn2_gate_e3_1 batch_size=4 num_workers=2 epochs=30)
