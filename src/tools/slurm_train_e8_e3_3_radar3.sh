#!/bin/bash
#SBATCH --job-name="radar_pfn2_gate_e8_e3_3_radar3_ro47020"
...
#SBATCH --output=outputs/slurm_radar_pfn2_gate_e8_e3_3_radar3_ro47020_%j.out
#SBATCH --error=outputs/slurm_radar_pfn2_gate_e8_e3_3_radar3_ro47020_%j.err
