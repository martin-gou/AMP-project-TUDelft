#!/bin/bash
#SBATCH --job-name="centperpoint_improved"
...
#SBATCH --output=outputs/slurm_centerpoint_improved_%j.out
#SBATCH --error=outputs/slurm_centerpoint_improved_%j.err
...
srun python -u src/tools/train.py model=centerpoint_radar_improved exp_id=centerpoint_radar_improved batch_size=4 num_workers=2 epochs=50
