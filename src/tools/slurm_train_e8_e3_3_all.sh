#!/bin/bash
#SBATCH --job-name="radar_pfn2_gate_e8_e3_3_all_ro47020"
...
#SBATCH --output=outputs/slurm_radar_pfn2_gate_e8_e3_3_all_ro47020_%j.out
#SBATCH --error=outputs/slurm_radar_pfn2_gate_e8_e3_3_all_ro47020_%j.err
...
default_args=(model=centerpoint_radar_pfn2_gate_e8_e3_3_all exp_id=radar_pfn2_gate_e8_e3_3_all batch_size=2 num_workers=2 epochs=20)
