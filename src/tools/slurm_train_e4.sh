#!/bin/bash
#SBATCH --job-name="centerpoint_e4_ro47020"
...
#SBATCH --output=outputs/slurm_centerpoint_e4_ro47020_%j.out
#SBATCH --error=outputs/slurm_centerpoint_e4_ro47020_%j.err
...
default_args=(model=centerpoint_radar_pfn2_gate_e4 exp_id=radar_pfn2_gate_e4 batch_size=4 num_workers=2 epochs=30)
